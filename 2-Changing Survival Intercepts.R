...
Outputlist <- list(
  US_2      = readRDS("Results_Scene2_US_N250.RDA"),
  England_2 = readRDS("Results_Scene2_England_N250.RDA"),
  India_2   = readRDS("Results_Scene2_India_N250.RDA"),
  China_2   = readRDS("Results_Scene2_China_N250.RDA"),
  Mexico_2  = readRDS("Results_Scene2_Mexico_N250.RDA"),
  US_3      = readRDS("Results_Scene3_US_N250.RDA"),
  England_3 = readRDS("Results_Scene3_England_N250.RDA"),
  India_3   = readRDS("Results_Scene3_India_N250.RDA"),
  China_3   = readRDS("Results_Scene3_China_N250.RDA"),
  Mexico_3  = readRDS("Results_Scene3_Mexico_N250.RDA")
)
