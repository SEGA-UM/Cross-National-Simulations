...
# Baseline hazard of diabetes lambda0 is calibrated so that the incidence rate over the follow-up period is close to age-standardized incidence rate in real world studies
  ...
  # We assume that countries with generally lower life expectancy will have larger effect sizes of diabetes on mortality
...
#### 6. Perform Analysis ####
setwd("/Users/kelvin/Library/CloudStorage/GoogleDrive-kelvinzh@umich.edu/My Drive/SEGA/Projects/Cross-national Simulation/Results/Results_20250711/4-Changing Diabetes by Country")
...
Outputlist <- list(
  US_2      = readRDS("Results_Scene2_US_N250_ChangingDiab.RDA"),
  England_2 = readRDS("Results_Scene2_England_N250_ChangingDiab.RDA"),
  India_2   = readRDS("Results_Scene2_India_N250_ChangingDiab.RDA"),
  China_2   = readRDS("Results_Scene2_China_N250_ChangingDiab.RDA"),
  Mexico_2  = readRDS("Results_Scene2_Mexico_N250_ChangingDiab.RDA"),
  US_3      = readRDS("Results_Scene3_US_N250_ChangingDiab.RDA"),
  England_3 = readRDS("Results_Scene3_England_N250_ChangingDiab.RDA"),
  India_3   = readRDS("Results_Scene3_India_N250_ChangingDiab.RDA"),
  China_3   = readRDS("Results_Scene3_China_N250_ChangingDiab.RDA"),
  Mexico_3  = readRDS("Results_Scene3_Mexico_N250_ChangingDiab.RDA")
)

countries <- c("US", "India", "England", "China", "Mexico")
scenarios <- c(2,3)
...
writexl::write_xlsx(summary_stats, "summary_stats_ChangingDiab.xlsx")
