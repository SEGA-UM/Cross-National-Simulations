...
# Baseline hazard of diabetes lambda0 is calibrated so that the incidence rate over the follow-up period is close to age-standardized incidence rate in real world studies
  ...
  # We assume that countries with generally lower life expectancy will have larger effect sizes of U on mortality
  g_U = switch(C,
               "England" = log(1.2), 
               "US" = log(1.4),
               "Mexico" = log(1.6),
...
multiple_output = function(N,C,I,seeds){
  ...
  saveRDS(results, file = sprintf("Results_Scene%s_%s_N%s_ChangingU.RDA", I, C, N))
  invisible(results)
  }


#### 6. Perform Analysis ####
setwd("/Users/kelvin/Library/CloudStorage/GoogleDrive-kelvinzh@umich.edu/My Drive/SEGA/Projects/Cross-national Simulation/Results/Results_20250711/3-Changing U by Country")
...
Outputlist <- list(
  US_2      = readRDS("Results_Scene2_US_N250_ChangingU.RDA"),
  England_2 = readRDS("Results_Scene2_England_N250_ChangingU.RDA"),
  India_2   = readRDS("Results_Scene2_India_N250_ChangingU.RDA"),
  China_2   = readRDS("Results_Scene2_China_N250_ChangingU.RDA"),
  Mexico_2  = readRDS("Results_Scene2_Mexico_N250_ChangingU.RDA"),
  US_3      = readRDS("Results_Scene3_US_N250_ChangingU.RDA"),
  England_3 = readRDS("Results_Scene3_England_N250_ChangingU.RDA"),
  India_3   = readRDS("Results_Scene3_India_N250_ChangingU.RDA"),
  China_3   = readRDS("Results_Scene3_China_N250_ChangingU.RDA"),
  Mexico_3  = readRDS("Results_Scene3_Mexico_N250_ChangingU.RDA")
)
...
writexl::write_xlsx(summary_stats, "summary_stats_ChangingU.xlsx")
